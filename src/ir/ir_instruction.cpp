...
std::string ir::CallInst::draw() const {
    std::string res = "call " + this->des.name + " " + ir::toString(this->des.type) + ", " + this->op1.name + "(";
...
std::string ir::Instruction::draw() const {
    ...
    case ir::Operator::alloc:
        return "alloc " + this->des.name + " " + toString(des.type) + ", " + this->op1.name + " " + toString(this->op1.type);
    case ir::Operator::mov:
        return "mov " + this->des.name + " " + toString(des.type) + ", " + this->op1.name + " " + toString(this->op1.type);
    case ir::Operator::fmov:
        return "fmov " + this->des.name + " " + toString(des.type) + ", " + this->op1.name + " " + toString(this->op1.type);
    case ir::Operator::cvt_f2i:
        return "cvt_f2i " + this->des.name + " " + toString(des.type) + ", " + this->op1.name + " " + toString(this->op1.type);
    case ir::Operator::cvt_i2f:
        return "cvt_i2f " + this->des.name + " " + toString(des.type) + ", " + this->op1.name + " " + toString(this->op1.type);
    case ir::Operator::def:
        return "def " + this->des.name + " " + toString(des.type) + ", " + this->op1.name + " " + toString(this->op1.type);
    case ir::Operator::fdef:
        return "fdef " + this->des.name + " " + toString(des.type) + ", " + this->op1.name + " " + toString(this->op1.type);
    case ir::Operator::_not:
        return "not " + this->des.name + " " + toString(des.type) + ", " + this->op1.name + " " + toString(this->op1.type);
    default:
        return toString(this->op) + " " + this->des.name + " " + toString(des.type) +
               ", " + this->op1.name + " " + toString(this->op1.type) + ", "
               + this->op2.name + " " + toString(this->op2.type);
